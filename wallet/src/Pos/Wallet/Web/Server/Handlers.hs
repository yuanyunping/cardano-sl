...
servantHandlers genesisConfig txpConfig ntpStatus submitTx = genericServerT A.WalletApiRecord
    { _test        = testHandlers
...
walletsHandlers genesisConfig = genericServerT A.WWalletsApiRecord
